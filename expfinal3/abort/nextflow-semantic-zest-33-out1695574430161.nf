...
workflow {
Channel.of(3..3,"j").set{namedchannel1}
namedchannel1  |  v  |  lpa 
Channel.of(776,"h".."q",6..0,4146,4..0,"l",98).multiMap { it -> one: two: it }.set{namedchannel2}
namedchannel2  |  juq_twovars |  aebp_twovars |  hbl_twovars |  bic_twovars |  yl_twovars |  qkm_twovars
