...
workflow {
Channel.of(3..8,4..8).set{namedchannel1}
namedchannel1  |  jg 
Channel.of(0093,4..8,25,2..5,"i").multiMap { it -> one: two: it }.set{namedchannel2}
namedchannel2  |  nczq_twovars
