...
workflow {
Channel.of("p","a".."a").set{namedchannel1}
namedchannel1  |  ft 
Channel.of("d".."n","r",1..0,"bwyg",08143,"e").multiMap { it -> one: two: it }.set{namedchannel2}
namedchannel2  |  xqbs_twovars
