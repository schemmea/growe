...
workflow {
Channel.of("z".."v",4..1,"z","a".."j",5..8,3..4).set{namedchannel1}
namedchannel1 
Channel.of("h".."v",8..8,"a".."t",09).multiMap { it -> one: two: it }.set{namedchannel2}
namedchannel2  |  gr_twovars |  mg_twovars
