...
workflow {
Channel.of(5671,08,"t".."r","k",7..5,"j","t".."z").set{namedchannel1}
namedchannel1  |  rbaa 
Channel.of(8..5,498,2..2,0..1,"g".."b").multiMap { it -> one: two: it }.set{namedchannel2}
namedchannel2  |  mt_twovars |  og_twovars |  ndq_twovars
