...
workflow {
Channel.of("h".."a","z").set{namedchannel1}
namedchannel1 
Channel.of("u".."s",08,1..5,"y".."b","d".."m").multiMap { it -> one: two: it }.set{namedchannel2}
namedchannel2  |  shz_twovars |  vs_twovars |  qy_twovars
