...
workflow {
Channel.of(04287177,"d".."r").set{namedchannel1}
namedchannel1  |  c  |  x 
Channel.of(8..2,"d").multiMap { it -> one: two: it }.set{namedchannel2}
namedchannel2  |  cor_twovars |  ebw_twovars |  glto_twovars
